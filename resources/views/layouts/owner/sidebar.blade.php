...
<a href="{{ route('owner.dashboard') }}"
   class="list-group-item sidebar-link {{ Request::is('owner/dashboard*') ? 'active' : '' }}">
...
@if(
    ...
    auth()->user()->hasPermission('read.pembayaran')
)
...
<a href="{{ route('admin.kategori-produk.index') }}"
   class="list-group-item sidebar-link {{ Request::is('admin/kategori-produk*') ? 'active' : '' }}">
...
<a href="{{ route('admin.produk.index') }}"
   class="list-group-item sidebar-link {{ Request::is('admin/produk*') ? 'active' : '' }}">
...
<a href="{{ route('admin.pelanggan.index') }}"
   class="list-group-item sidebar-link {{ Request::is('admin/pelanggan*') ? 'active' : '' }}">
...
<a href="{{ route('admin.pembayaran.index') }}"
   class="list-group-item sidebar-link {{ Request::is('admin/pembayaran*') ? 'active' : '' }}">
